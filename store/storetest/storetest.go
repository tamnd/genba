...
var cases = []testCase{
	...
	{"withdrawing takes back one person's line and leaves the rest", testWithdraw},
	{"withdrawing the last thing said leaves the document unreported", testWithdrawLast},
	{"a report cannot be withdrawn across a permission", testWithdrawPermissions},
	{"what came back says whether the reader is one of the people who said it", testReportMine},
